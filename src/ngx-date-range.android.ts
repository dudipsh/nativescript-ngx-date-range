...
export class NgxDateRange extends Common {
  ...
  public initCalendar(): any {
    ...
    if (options.minDate && new Date(options.minDate).getDate()) {
      const minDate = new Date(options.minDate);
      lastYear.set(java.util.Calendar.YEAR, minDate.getFullYear());
      lastYear.set(java.util.Calendar.MONTH, minDate.getMonth());
      lastYear.set(java.util.Calendar.DAY_OF_MONTH, minDate.getDate());
    } else {
    ...
    if (options.maxDate && new Date(options.maxDate).getDate()) {
      const maxDate = new Date(options.maxDate);
      nextYear.set(java.util.Calendar.YEAR, maxDate.getFullYear());
      nextYear.set(java.util.Calendar.MONTH, maxDate.getMonth());
      nextYear.set(java.util.Calendar.DAY_OF_MONTH, maxDate.getDate());
    } else {
    ...
    } else if (options.minDate && new Date(options.minDate).getDate()) {
      today = new java.util.Date(options.minDate);
    }
    // @ts-ignore
